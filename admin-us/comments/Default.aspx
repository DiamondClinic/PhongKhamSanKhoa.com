            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-header" runat="server">
                        <asp:Button ID="btnViewAll" runat="server" Text="Xem Tất cả" OnClick="btnViewAll_Click" CssClass="btn-blue" />
                        <asp:Button ID="btnChuaDuyet" runat="server" Text="Xem Chưa Duyệt " OnClick="btnChuaDuyet_Click" CssClass="btn-blue" />
                    </div>
                    ...
                    <div class="search">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnTim" runat="server" Text="Tìm" CssClass="btn" OnClick="btnTim_Click" />
                                </td>
                            </tr>
                        </table>
                    </div>
