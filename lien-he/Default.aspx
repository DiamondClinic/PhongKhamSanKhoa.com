<%@ Page Title="Liên hệ phòng khám phụ khoa Diamond" MetaDescription="Phòng khám phụ khoa Diamond là trung tâm y khoa chất lượng cao luôn tận tâm với người bệnh Hotline: (08) 3930 75 75  Đ/c:Số 9, Trần Quốc Thảo, P.6, Q3" Language="C#" MasterPageFile="~/Share/san-khoa/Right_layout.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="ban_do_Default" %>
