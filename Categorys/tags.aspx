            ...
            <ItemTemplate>
                <div class="large-4 columns">
                    <article class="post col-2">
                        ...
                        <h2>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/" + Eval("id_tt")  %>'> <%# Eval("Title") %></asp:HyperLink></h2>
                        ...
                        <div class='fb-like' data-href='<%# "~/" + Eval("id_tt")  %>' data-layout='standard' data-action='like' data-show-faces='true' data-share='true'></div>
                    </article>
                </div>
            </ItemTemplate>
        </asp:Repeater>
