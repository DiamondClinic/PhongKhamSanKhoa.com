<%@ Page Title='<%: Page.Title %>' Language="C#" MasterPageFile="~/Share/san-khoa/Right_layout.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Categorys_Default" %>
            ...
            <ItemTemplate>
                <div class="col-md-4 col-news ">
                    <article class="col-2 post-s">
                        <div class="post_img">
                            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%# "~/" + Eval("code") +".hxml" %>' AlternateText='<%# Eval("name") %>' ImageUrl='<%# Eval("urlct").ToString().Trim() == ""?  "~/UploadFile/DanhMuc/noimg.jpg" : "~/UploadFile/DanhMuc/"+Eval("urlct") %>'> <%# Eval("name") %></asp:HyperLink>

                        </div>
                        
                        <h3>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/" + Eval("code") +".hxml"   %>'> <%# Eval("name") %></asp:HyperLink></h3>
